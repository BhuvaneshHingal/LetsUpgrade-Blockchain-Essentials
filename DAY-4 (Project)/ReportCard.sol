...
contract ReportCard{
    ...
    function getReportCardDetails() public view returns(string, string, uint, uint, uint, uint, uint, uint, uint) {
        return(name, batch, rollno, marks_sub1, marks_sub2, marks_sub3, marks_sub4, result,percent);    
    }
}